locals {
  ...
  app_name             = "${local.infra_environment}-dep-processors"
...
dependency "iam-role-dep-processors" {
  config_path = "${get_terragrunt_dir()}/../iam-role-dep-processors"
...
inputs = {
  ...
  iam_instance_profile = dependency.iam-role-dep-processors.outputs.iam_instance_profile_id
